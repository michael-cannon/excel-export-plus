					...
					<form name="frm_export_options" id="frm_export_options" method="post" action="">
						...
						<fieldset class="parameter_container">
							...
							<div style="padding-left:20px; padding-bottom:10px;">
								Split in multiples files with <input type="text" value="" name="split_file_records_number" id="split_file_records_number" class="input-mini"> records each
								<br>
								Total of <span id="record_count_html"></span> record(s) to be exported.
								<br>
								Total of <span id="file_count_html">1</span> file(s) will be generated
							</div>
						</fieldset>
